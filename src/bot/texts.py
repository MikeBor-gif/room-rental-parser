...
BOT_DESCRIPTION = (  # в пустом чате до «Старт», до 512 символов
    "Присылаю новые объявления об аренде комнат и квартир с Kufar, Onliner "
    "и Realt — раньше, чем их увидит большинство.\n\n"
...
BOT_SHORT_DESCRIPTION = (  # в профиле и при пересылке, до 120 символов
    "Новые объявления аренды (Kufar, Onliner, Realt) по вашим фильтрам: "
    "комнаты и квартиры, 6 городов, фото."
)

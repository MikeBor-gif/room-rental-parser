...
- [ ] **T3. Справочник городов `src/cities.py`**
...
- [ ] **T4. Модель `Listing`: property_type, city_code, photo_url**
...
- [ ] **T5. Kufar: вся страна, комнаты + квартиры, фото**
...
- [ ] **T6. Onliner: вся страна, комнаты + квартиры, фото**
...
- [ ] **T7. Realt: вся страна, комнаты + квартиры, фото**
...
- [ ] **T8. Расширение Telegram-клиента `src/telegram.py`**
...
- [ ] **T9. Роутер апдейтов `src/bot/router.py` + диалоговые состояния**
...
- [ ] **T10. Тексты бота `src/bot/texts.py`**
...
- [ ] **T11. Тарифы и матчинг `src/tariffs.py` + `src/matching.py`**
...
- [ ] **T13. Платёжный модуль `src/payments/`**

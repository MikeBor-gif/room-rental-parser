...
- [x] **T14. Точки входа `src/jobs/updates.py` и `src/jobs/scrape.py`**
...
- [x] **T16. Тесты новой функциональности**
...
- [x] **T17. Оформление и подготовка к запуску**
